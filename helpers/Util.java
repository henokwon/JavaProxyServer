...
public class Util {
     ...
     * @param  url The Url E.g. http://merketermap.org/index.html
     * @return     The Hostname E.g. merketermap.org
     */
     ...
     * @param  url The Url E.g. http://merketermap.org/f00/80
     * @return     The Port number E.g. 80
     */
     ...
     * @param  url The Url  E.g. http://merketermap.org/foo/bar
     * @return     The location E.g. /foo/bar
     */
    ...
    public static Date toDate(String dateStr, String format) {
     ...
     /**
     * Converts a string to a Java date object using "E, dd MMM yyyy HH:mm:ss z" (Mon, 13 feb 2023 21:06:31 GMT) as the format.
     * @param  dateStr The string that is parsed as a date.
     * @return         Returns a new date object. On failure it will return null.
     */
